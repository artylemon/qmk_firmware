...
// Number row mods used on the FN2 numpad layer
...
#define FN_MAC MO(MAC_FN1)
#define FN_WIN MO(WIN_FN1)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_iso_85(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 KC_RALT,  FN_MAC,   KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [MAC_FN1] = LAYOUT_iso_85(
    ...
    // Modified layer enabled by the board's Win/Mac switch (Win position).
    [WIN_BASE] = LAYOUT_iso_85(
        ...
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_PGUP,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,                      KC_PGDN,
        KC_CAPS,  HOME_A,   HOME_S,   HOME_D,   HOME_F,   KC_G,     KC_H,     HOME_J,   HOME_K,   HOME_L,   HOME_SCLN,KC_QUOT,  KC_NUHS,  KC_ENT,             KC_HOME,
        KC_LSFT,  KC_NUBS,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,    KC_END,
        KC_LCTL,  KC_LGUI,  KC_LALT,                               LT(FN2, KC_SPC),                         KC_RALT,  FN_WIN,   KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [WIN_FN1] = LAYOUT_iso_85(
    ...
    // Hold space from WIN_BASE to access a right-hand numpad cluster.
    [FN2] = LAYOUT_iso_85(
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  KC_TILD,  KC_SCLN,  KC_LBRC,  KC_RBRC,  _______,  _______,  KC_7,     KC_8,     KC_9,     _______,  _______,  _______,                      _______,
        _______,  KC_GRV,   KC_QUOT,  HOME_9,   HOME_0,   _______,  _______,  HOME_4,   HOME_5,   HOME_6,   HOME_MINS,_______,  _______,  _______,            _______,
        _______,  KC_BSLS,  KC_SLSH,  KC_COMM,  KC_DOT,   BAT_LVL,  _______,  KC_0,     KC_1,     KC_2,     KC_3,     _______,  _______,  _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______,  _______)
};
// clang-format on
